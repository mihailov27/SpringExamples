...
import com.mm.movies.*;

import org.apache.commons.csv.CSVRecord;

public class MovieMapper extends BaseMapper<Movie> implements Mapper<Movie> {
    ...
    public Movie map(CSVRecord csvRecord) throws CsvParsingException {
        ...
        movie.setGenres(toSetFromJsonArray(csvRecord, Keys.GENRES, Genre.class));
